    ...
    <div className="app-bg min-h-screen flex items-center justify-center px-4 py-10">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Start tracking expenses across currencies.</p>
        </div>
        ...
        <GlassCard strong className="p-6 sm:p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-600 dark:text-slate-300 mb-1.5">Preferred currency</label>
              <select
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
          ...
          <Link to="/login" className="focus-ring font-semibold text-brand-600 dark:text-brand-300 hover:text-brand-800 dark:hover:text-brand-200">
            Log in
          </Link>
        </p>
      </motion.div>
